...
class CanAskingPage extends StatefulWidget {
  const CanAskingPage({super.key});

  @override
  State<CanAskingPage> createState() => _CanAskingPageState();
}

class _CanAskingPageState extends State<CanAskingPage> {
  User? user;
  String? userId;
